...
class StartUpPortfolioVC: CommonVC {
    ...
    @objc fileprivate func onAddAction(_ sender: UIButton) {
        guard portfolios.count < 2 else {
            alert(message: "At this time, you can upload 2 photos")
            return
        }
...
extension StartUpPortfolioVC: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension StartUpPortfolioVC: ImagePickerDelegate {
